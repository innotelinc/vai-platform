 ...
 */
export const listInterviewsApiV1InterviewsGet = <ThrowOnError extends boolean = false>(options?: Options<ListInterviewsApiV1InterviewsGetData, ThrowOnError>): RequestResult<ListInterviewsApiV1InterviewsGetResponses, ListInterviewsApiV1InterviewsGetErrors, ThrowOnError> => (options?.client ?? client).get<ListInterviewsApiV1InterviewsGetResponses, ListInterviewsApiV1InterviewsGetErrors, ThrowOnError>({ url: '/api/v1/interviews', ...options });
